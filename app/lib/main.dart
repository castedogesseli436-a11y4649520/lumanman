        ...
        _speechInitialized = await _speech.initialize(
          ...
          onStatus: (status) {
            ...
            setState(() {
              ...
              _speechHint = _listening ? '正在听，请说普通话…' : '语音输入已结束，点麦克风可继续';
            });
          },
          onError: (error) {
            if (!mounted) return;
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                tooltip: _listening ? '停止语音输入' : '语音转文字（普通话）',
                onPressed: _startingSpeech ? null : _toggleSpeech,
                icon: _startingSpeech
