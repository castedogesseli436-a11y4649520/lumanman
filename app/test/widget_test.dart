...
Future<void> _openPraise(WidgetTester tester) async {
  await tester.scrollUntilVisible(find.byKey(const Key('open-praise')), 250);
  await tester.ensureVisible(find.byKey(const Key('open-praise')));
